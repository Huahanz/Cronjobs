...
class StockJob:
    ...
    def get_stock_list(self):
        tsla = nasdaqstock.StockModel('tsla', 'qwidget-dollar', 130, 190)
        yahoo = nasdaqstock.StockModel('yhoo', 'qwidget-dollar', 35, 45)
        bac = nasdaqstock.StockModel('bac', 'qwidget-dollar', 14, 18)
        return [tsla, yahoo, bac]
